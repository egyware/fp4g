...
public class FP4GParser extends Parser {
	...
	public final OnFiltersContext onFilters() throws RecognitionException {
		...
		try {
			...
			while (_la==ID) {
				{
				{
				setState(249); ((OnFiltersContext)_localctx).filter = filter();
				_localctx.or.add(((OnFiltersContext)_localctx).filter.filters);
				}
				}
				setState(256);
	...
	public final FilterContext filter() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(257); ((FilterContext)_localctx).ID = match(ID);
			...
			while (_la==COMA) {
				...
				setState(260); ((FilterContext)_localctx).ID = match(ID);
				_localctx.filters.add((((FilterContext)_localctx).ID!=null?((FilterContext)_localctx).ID.getText():null));
				}
				}
				setState(266);
	...
	public final DeclareVarContext declareVar() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(299); varType();
			setState(300); ((DeclareVarContext)_localctx).varName = match(ID);
			setState(303);
			_la = _input.LA(1);
			if (_la==EQUAL) {
				{
				setState(301); match(EQUAL);
				setState(302); ((DeclareVarContext)_localctx).initValue = expr(0);
				}
			}
	...
	public final VarTypeContext varType() throws RecognitionException {
		...
		try {
			...
			case NUMBER_TYPE:
				enterOuterAlt(_localctx, 1);
				{
				setState(305); match(NUMBER_TYPE);
			...
			case STRING_TYPE:
				enterOuterAlt(_localctx, 3);
				{
				setState(309); match(STRING_TYPE);
			...
			case ID:
				enterOuterAlt(_localctx, 4);
				{
				setState(311); ((VarTypeContext)_localctx).ID = match(ID);
	...
	public final AssetsContext assets() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(315); match(ASSETS);
			setState(316); match(ABRE_COR);
			...
			if (_la==COMA) {
				{
				setState(325); match(COMA);
				}
			}

			setState(328); match(CIERRA_COR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AssetValueContext assetValue() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(330); ((AssetValueContext)_localctx).assetType = match(ID);
			setState(332);
			_la = _input.LA(1);
			if (_la==ID) {
				{
				setState(331); ((AssetValueContext)_localctx).assetName = match(ID);
				}
			}

			setState(334); match(DOUBLEDOT);
			setState(335); ((AssetValueContext)_localctx).asset = match(STRING_LITERAL);
			setState(337);
			_la = _input.LA(1);
			if (_la==ABRE_COR) {
				{
				setState(336); ((AssetValueContext)_localctx).innerAssetValues = assetValuesInner();
				}
			}
	...
	public final AssetValueInnerContext assetValueInner() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(353); ((AssetValueInnerContext)_localctx).assetType = match(ID);
			setState(355);
			_la = _input.LA(1);
			if (_la==ID) {
				{
				setState(354); ((AssetValueInnerContext)_localctx).assetName = match(ID);
				}
			}

			setState(357); match(DOUBLEDOT);
			setState(358); ((AssetValueInnerContext)_localctx).asset = match(STRING_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(362); ((NotExprContext)_localctx).op = expr(13);
				}
				break;
			...
			case 2:
				...
				setState(364); ((MinusExprContext)_localctx).op = expr(12);
				}
				break;
			...
			case 4:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(366); match(ABRE_PAR);
				setState(367); ((ParExprContext)_localctx).op = expr(0);
				setState(368); match(CIERRA_PAR);
				}
				break;
			...
			case 6:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(371); match(DECIMAL_LITERAL);
				}
				break;
			...
			case 7:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(372); match(BOOL_LITERAL);
				}
				break;
			...
			case 10:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(375); ((FunctionCallExprContext)_localctx).functionName = match(ID);
				setState(376); match(ABRE_PAR);
				setState(377); exprList();
				setState(378); match(CIERRA_PAR);
				}
				break;
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(384); match(MULTIPLY);
						setState(385); ((MultExprContext)_localctx).right = expr(12);
						}
						break;
					...
					case 2:
						...
						setState(387); match(DIVIDE);
						setState(388); ((DivExprContext)_localctx).right = expr(11);
						}
						break;
					...
					case 3:
						...
						setState(390); match(PLUS);
						setState(391); ((AddExprContext)_localctx).right = expr(10);
						}
						break;
					...
					case 4:
						...
						setState(393); match(MINUS);
						setState(394); ((SubExprContext)_localctx).right = expr(9);
						}
						break;
					}
					} 
	...
	public final AccessVarOpContext accessVarOp() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(400); ((AccessVarNameContext)_localctx).var = varOp();
				}
				break;
			...
			case 2:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(401); ((AccessVarOperatorContext)_localctx).pVar = parentVarOp();
				setState(404);
				switch ( getInterpreter().adaptivePredict(_input,33,_ctx) ) {
				case 1:
					{
					setState(402); match(DOT);
					setState(403); ((AccessVarOperatorContext)_localctx).propertyAccess = accessVarOp();
					}
					break;
				}
				}
	...
	public final ParentVarOpContext parentVarOp() throws RecognitionException {
		...
		try {
			...
			case CURRENT_LITERAL:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(408); match(CURRENT_LITERAL);
				}
				break;
			case PARENT_LITERAL:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(409); match(PARENT_LITERAL);
				}
				break;
			case MANAGER:
			case GAME:
			...
			case ID:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(410); ((VarNameOperatorContext)_localctx).varName = varID();
	...
	public final VarOpContext varOp() throws RecognitionException {
		...
		try {
			...
			case CURRENT_LITERAL:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(415); match(CURRENT_LITERAL);
				}
				break;
			case PARENT_LITERAL:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(416); match(PARENT_LITERAL);
				}
				break;
			case MANAGER:
			case GAME:
			...
			case ID:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(417); ((VarNameContext)_localctx).varName = varID();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(422); match(ABRE_LLAV);
			setState(423); arrayBody();
			setState(424); match(CIERRA_LLAV);
			setState(428);
			switch ( getInterpreter().adaptivePredict(_input,37,_ctx) ) {
			case 1:
				{
				setState(425); match(AS);
				setState(426); ((ArrayContext)_localctx).ID = match(ID);
	...
	public final ParArrayContext parArray() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(456); ((ParArrayContext)_localctx).ID = match(ID);
	...
	public static final String _serializedATN =
		...
		"\n\22\f\22\16\22\u0102\13\22\3\23\3\23\3\23\3\23\3\23\7\23\u0109\n\23"+
		"\f\23\16\23\u010c\13\23\3\24\7\24\u010f\n\24\f\24\16\24\u0112\13\24\3"+
		"\25\3\25\3\25\3\25\3\25\3\25\3\25\3\25\5\25\u011c\n\25\3\26\3\26\3\26"+
		"\7\26\u0121\n\26\f\26\16\26\u0124\13\26\3\27\3\27\3\27\7\27\u0129\n\27"+
		"\f\27\16\27\u012c\13\27\3\30\3\30\3\30\3\30\5\30\u0132\n\30\3\31\3\31"+
		"\3\31\3\31\3\31\3\31\3\31\3\31\5\31\u013c\n\31\3\32\3\32\3\32\3\32\3\32"+
		"\7\32\u0143\n\32\f\32\16\32\u0146\13\32\3\32\5\32\u0149\n\32\3\32\3\32"+
		"\3\33\3\33\5\33\u014f\n\33\3\33\3\33\3\33\5\33\u0154\n\33\3\34\3\34\3"+
		"\34\3\34\7\34\u015a\n\34\f\34\16\34\u015d\13\34\3\34\5\34\u0160\n\34\3"+
		"\34\3\34\3\35\3\35\5\35\u0166\n\35\3\35\3\35\3\35\3\36\3\36\3\36\3\36"+
		"\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36"+
		"\3\36\3\36\3\36\5\36\u0180\n\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36\3\36"+
		"\3\36\3\36\3\36\3\36\7\36\u018e\n\36\f\36\16\36\u0191\13\36\3\37\3\37"+
		"\3\37\3\37\5\37\u0197\n\37\5\37\u0199\n\37\3 \3 \3 \3 \3 \5 \u01a0\n "+
		"\3!\3!\3!\5!\u01a5\n!\3\"\3\"\3#\3#\3#\3#\3#\3#\5#\u01af\n#\3$\3$\3$\7"+
		"$\u01b4\n$\f$\16$\u01b7\13$\3$\5$\u01ba\n$\3$\3$\3$\7$\u01bf\n$\f$\16"+
		"$\u01c2\13$\3$\5$\u01c5\n$\5$\u01c7\n$\3%\3%\3&\3&\3&\3&\3&\3&\2\'\2\4"+
		"\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60\62\64\668:<>@BDFH