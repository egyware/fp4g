...
public class FP4GParser extends Parser {
	...
	public static final String[] ruleNames = {
		...
		"usingValue", "game", "gameValues", "gameValue", "set", "start", "subscribe", 
	...
	public final UsingContext using() throws RecognitionException {
		...
		try {
			...
			case ID:
				{
				setState(144); ((UsingContext)_localctx).ID = match(ID);
			...
			setState(148); ((UsingContext)_localctx).name = match(ID);
			setState(154);
			switch (_input.LA(1)) {
			case DOTCOMA:
				{
				setState(149); match(DOTCOMA);
				}
				break;
			case ABRE_COR:
				{
				setState(150); match(ABRE_COR);
				setState(151); usingValues();
	...
	public final GameContext game() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(170); match(DEFINE);
			setState(171); match(GAME);
			setState(172); ((GameContext)_localctx).ID = match(ID);
			 ((GameContext)_localctx).name =  (((GameContext)_localctx).ID!=null?((GameContext)_localctx).ID.getText():null); 
			setState(174); match(ABRE_COR);
			setState(175); gameValues();
			setState(176); match(CIERRA_COR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SetContext set() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(202); match(SET);
			setState(203); ((SetContext)_localctx).ID = match(ID);
			 ((SetContext)_localctx).key =  (((SetContext)_localctx).ID!=null?((SetContext)_localctx).ID.getText():null); 
			setState(205); match(EQUAL);
			setState(206); expr(0);
			}
		}
		catch (RecognitionException re) {
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			setState(209); ((StartContext)_localctx).ID = match(ID);
	...
	public final SubscribeContext subscribe() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(212); match(SUBSCRIBE);
			setState(213); ((SubscribeContext)_localctx).where = match(ID);
			setState(214); match(ON);
			setState(215); ((SubscribeContext)_localctx).message = match(ID);
			setState(218);
			_la = _input.LA(1);
			if (_la==DOUBLEDOT) {
				{
				setState(216); match(DOUBLEDOT);
				setState(217); ((SubscribeContext)_localctx).method = match(ID);
				}
			}
	...
	public final UnsubscribeContext unsubscribe() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(220); match(UNSUBSCRIBE);
			setState(221); ((UnsubscribeContext)_localctx).where = match(ID);
			setState(222); match(ON);
			setState(223); ((UnsubscribeContext)_localctx).message = match(ID);
			setState(226);
			_la = _input.LA(1);
			if (_la==DOUBLEDOT) {
				{
				setState(224); match(DOUBLEDOT);
				setState(225); ((UnsubscribeContext)_localctx).method = match(ID);
				}
			}
	...
	public final AddContext add() throws RecognitionException {
		...
		try {
			...
			case GOAL:
				{
				setState(229); addDefine();
				}
				break;
			case ID:
				{
				setState(230); addMethod();
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			if (_la==ABRE_PAR) {
				...
				if (((((_la - 20)) & ~0x3f) == 0 && ((1L << (_la - 20)) & ((1L << (MANAGER - 20)) | (1L << (GAME - 20)) | (1L << (STATE - 20)) | (1L << (ASSET - 20)) | (1L << (BEHAVIOR - 20)) | (1L << (ENTITY - 20)) | (1L << (GOAL - 20)) | (1L << (MESSAGE - 20)) | (1L << (EMPTY - 20)) | (1L << (ABRE_PAR - 20)) | (1L << (ABRE_LLAV - 20)) | (1L << (MINUS - 20)) | (1L << (NOT - 20)) | (1L << (DIRECTCODE - 20)) | (1L << (INT_LITERAL - 20)) | (1L << (DECIMAL_LITERAL - 20)) | (1L << (STRING_LITERAL - 20)) | (1L << (BOOL_LITERAL - 20)) | (1L << (CURRENT_LITERAL - 20)) | (1L << (ID - 20)))) != 0)) {
					{
					setState(248); exprList();
					}
				}

				setState(251); match(CIERRA_PAR);
				}
			}
			...
			if (_la==EMPTY || _la==ABRE_LLAV) {
				{
				setState(254); ((AddDefineContext)_localctx).exprParams = array();
				}
			}
	...
	public final AddMethodContext addMethod() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(257); ((AddMethodContext)_localctx).ID = match(ID);
			...
			if (_la==EMPTY || _la==ABRE_LLAV) {
				{
				setState(264); ((AddMethodContext)_localctx).exprParams = array();
				}
			}
	...
	public final DefineContext define() throws RecognitionException {
		...
		try {
			...
			setState(286); ((DefineContext)_localctx).ID = match(ID);
			...
			if (_la==ABRE_PAR) {
				...
				setState(290); match(CIERRA_PAR);
				}
			}

			setState(294); match(ABRE_COR);
			setState(295); defineValues();
			setState(296); match(CIERRA_COR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OnContext on() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(298); match(ON);
			setState(299); ((OnContext)_localctx).ID = match(ID);
			...
			if (_la==DOUBLEDOT) {
				...
				setState(302); ((OnContext)_localctx).filters = onFilters();
				}
			}

			setState(305); match(ABRE_COR);
			setState(306); statements();
			setState(307); match(CIERRA_COR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case DESTROY:
				enterOuterAlt(_localctx, 2);
				{
				setState(318); destroy();
				}
				break;
			case SUBSCRIBE:
				enterOuterAlt(_localctx, 3);
				{
				setState(319); subscribe();
				}
				break;
			case UNSUBSCRIBE:
				enterOuterAlt(_localctx, 4);
				{
				setState(320); unsubscribe();
				}
				break;
			case ID:
				enterOuterAlt(_localctx, 5);
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(324); ((AssignContext)_localctx).varName = match(ID);
			setState(325); match(EQUAL);
			setState(326); expr(0);
			}
		}
		catch (RecognitionException re) {
	...
	public final SendContext send() throws RecognitionException {
		...
		try {
			...
			setState(331); match(SEND);
			setState(332); ((SendContext)_localctx).method = match(ID);
			...
			if (_la==TO) {
				...
				case OTHER:
					{
					setState(342); ((SendContext)_localctx).receiver = match(OTHER);
					((SendContext)_localctx).receiverType =  Instance.Other;
					}
					break;
				case GAME:
					{
					setState(344); ((SendContext)_localctx).receiver = match(GAME);
					((SendContext)_localctx).receiverType =  Instance.Game;
					}
					break;
				case ID:
					{
					setState(346); ((SendContext)_localctx).receiver = match(ID);
	...
	public final FilterContext filter() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(360); ((FilterContext)_localctx).ID = match(ID);
	...
	public final NameListContext nameList() throws RecognitionException {
		...
		try {
			...
			while (_la==COMA) {
				{
				{
				setState(400); match(COMA);
				setState(401); declareVar();
				}
				}
				setState(406);
				_errHandler.sync(this);
	...
	public final DeclareVarContext declareVar() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(407); varType();
			setState(408); ((DeclareVarContext)_localctx).varName = match(ID);
			setState(411);
			_la = _input.LA(1);
			if (_la==EQUAL) {
				{
				setState(409); match(EQUAL);
				setState(410); ((DeclareVarContext)_localctx).initValue = expr(0);
				}
			}
	...
	public final VarTypeContext varType() throws RecognitionException {
		...
		try {
			...
			case NUMBER_TYPE:
				enterOuterAlt(_localctx, 1);
				{
				setState(413); match(NUMBER_TYPE);
			...
			case STRING_TYPE:
				enterOuterAlt(_localctx, 3);
				{
				setState(417); match(STRING_TYPE);
			...
			case INTEGER_TYPE:
				enterOuterAlt(_localctx, 4);
				{
				setState(419); match(INTEGER_TYPE);
			...
			case DOUBLE_TYPE:
				enterOuterAlt(_localctx, 5);
				{
				setState(421); match(DOUBLE_TYPE);
			...
			case ID:
				...
				{
				setState(425); ((VarTypeContext)_localctx).id = defineID();
	...
	public final DefineIDContext defineID() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(430); ((DefineIDContext)_localctx).defineType = match(ID);
				setState(431); match(DOUBLEDOT);
			...
			setState(435); ((DefineIDContext)_localctx).defineName = match(ID);
	...
	public final AssetsContext assets() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(438); match(ASSETS);
			setState(439); match(ABRE_COR);
			setState(440); assetValueWithInnerValue();
			setState(445);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(442); assetValueWithInnerValue();
					}
					} 
				}
				setState(447);
	...
	public final AssetValueWithInnerValueContext assetValueWithInnerValue() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(453); ((AssetValueWithInnerValueContext)_localctx).value = assetValue();
			setState(455);
			_la = _input.LA(1);
			if (_la==ABRE_COR) {
				{
				setState(454); ((AssetValueWithInnerValueContext)_localctx).innerAssets = assetValuesInner();
				}
			}
	...
	public final AssetValueContext assetValue() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(457); ((AssetValueContext)_localctx).assetType = match(ID);
			setState(459);
			_la = _input.LA(1);
			if (_la==ID) {
				{
				setState(458); ((AssetValueContext)_localctx).assetName = match(ID);
				}
			}

			setState(461); match(DOUBLEDOT);
			setState(462); ((AssetValueContext)_localctx).assetPath = match(STRING_LITERAL);
			setState(464);
			_la = _input.LA(1);
			if (_la==EMPTY || _la==ABRE_LLAV) {
				{
				setState(463); ((AssetValueContext)_localctx).exprParams = array();
				}
			}
	...
	public final AssetValuesInnerContext assetValuesInner() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(466); match(ABRE_COR);
			setState(467); assetValue();
			setState(472);
			_errHandler.sync(this);
			...
			if (_la==COMA) {
				{
				setState(475); match(COMA);
				}
			}

			setState(478); match(CIERRA_COR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FlagContext flag() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(480); match(FLAG);
			setState(481); declareVar();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final WhenContext when() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(483); match(WHEN);
			setState(484); ((WhenContext)_localctx).condition = expr(0);
			setState(485); match(THEN);
			setState(486); ((WhenContext)_localctx).stmnt = statement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(490); ((NotExprContext)_localctx).op = expr(17);
				}
				break;
			...
			case 2:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(491); match(MINUS);
				setState(492); ((MinusExprContext)_localctx).op = expr(12);
				}
				break;
			...
			case 4:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(494); match(ABRE_PAR);
				setState(495); ((ParExprContext)_localctx).op = expr(0);
			...
			case 5:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(498); match(INT_LITERAL);
				}
				break;
			...
			case 6:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(499); match(DECIMAL_LITERAL);
				}
				break;
			...
			case 8:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(501); match(BOOL_LITERAL);
				}
				break;
			...
			case 10:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(503); ((FunctionCallExprContext)_localctx).functionName = match(ID);
				setState(504); match(ABRE_PAR);
				setState(506);
				_la = _input.LA(1);
				if (((((_la - 20)) & ~0x3f) == 0 && ((1L << (_la - 20)) & ((1L << (MANAGER - 20)) | (1L << (GAME - 20)) | (1L << (STATE - 20)) | (1L << (ASSET - 20)) | (1L << (BEHAVIOR - 20)) | (1L << (ENTITY - 20)) | (1L << (GOAL - 20)) | (1L << (MESSAGE - 20)) | (1L << (EMPTY - 20)) | (1L << (ABRE_PAR - 20)) | (1L << (ABRE_LLAV - 20)) | (1L << (MINUS - 20)) | (1L << (NOT - 20)) | (1L << (DIRECTCODE - 20)) | (1L << (INT_LITERAL - 20)) | (1L << (DECIMAL_LITERAL - 20)) | (1L << (STRING_LITERAL - 20)) | (1L << (BOOL_LITERAL - 20)) | (1L << (CURRENT_LITERAL - 20)) | (1L << (ID - 20)))) != 0)) {
					{
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(513); match(LESS_THAN);
						setState(514); ((LessThanExprContext)_localctx).right = expr(17);
						}
						break;
					...
					case 2:
						...
						setState(516); match(MORE_THAN);
						setState(517); ((MoreThanExprContext)_localctx).right = expr(16);
						}
						break;
					...
					case 3:
						...
						setState(520); ((EqualExprContext)_localctx).right = expr(15);
						}
						break;
					...
					case 4:
						...
						setState(522); match(MULTIPLY);
						setState(523); ((MultExprContext)_localctx).right = expr(12);
						}
						break;
					...
					case 5:
						...
						setState(525); match(DIVIDE);
						setState(526); ((DivExprContext)_localctx).right = expr(11);
						}
						break;
					...
					case 6:
						...
						setState(529); ((AddExprContext)_localctx).right = expr(10);
						}
						break;
					...
					case 7:
						...
						setState(531); match(MINUS);
						setState(532); ((SubExprContext)_localctx).right = expr(9);
						}
						break;
					}
					} 
	...
	public final AccessVarOpContext accessVarOp() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(538); ((AccessVarNameContext)_localctx).var = varOp();
				}
				break;
			...
			case 2:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(539); ((AccessVarOperatorContext)_localctx).pVar = parentVarOp();
				setState(540); match(DOT);
				setState(541); ((AccessVarOperatorContext)_localctx).propertyAccess = accessVarOp();
				}
				break;
			}
		}
	...
	public final ParentVarOpContext parentVarOp() throws RecognitionException {
		...
		try {
			...
			case CURRENT_LITERAL:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(545); match(CURRENT_LITERAL);
				}
				break;
			case MANAGER:
			case GAME:
			...
			case ID:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(546); ((VarNameOperatorContext)_localctx).varName = varID();
	...
	public final VarOpContext varOp() throws RecognitionException {
		...
		try {
			...
			case ID:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(552); ((VarNameContext)_localctx).varName = varID();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ArrayBodyContext arrayBody() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(559); match(ABRE_LLAV);
				{
				setState(560); parArray();
				setState(565);
				_errHandler.sync(this);
				...
				setState(571); match(CIERRA_LLAV);
				setState(575);
				switch ( getInterpreter().adaptivePredict(_input,55,_ctx) ) {
				case 1:
					{
					setState(572); match(AS);
					setState(573); ((AssocArrayContext)_localctx).ID = match(ID);
			...
			case 2:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(577); match(ABRE_LLAV);
				{
				setState(578); itemArray();
				setState(583);
				_errHandler.sync(this);
				...
				setState(589); match(CIERRA_LLAV);
				setState(593);
				switch ( getInterpreter().adaptivePredict(_input,58,_ctx) ) {
				case 1:
					{
					setState(590); match(AS);
					setState(591); ((ListArrayContext)_localctx).ID = match(ID);
			...
			case 3:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(595); match(EMPTY);
				setState(596); match(AS);
				setState(597); ((EmptyArrayContext)_localctx).ID = match(ID);
	...
	public final ParArrayContext parArray() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(603); ((ParArrayContext)_localctx).ID = match(ID);
	...
	public static final String _serializedATN =
		...
		"\3\3\3\3\3\3\3\3\4\7\4n\n\4\f\4\16\4q\13\4\3\5\3\5\3\5\3\5\7\5w\n\5\f"+
		"\5\16\5z\13\5\3\6\3\6\3\6\3\6\3\6\7\6\u0081\n\6\f\6\16\6\u0084\13\6\3"+
		"\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\5\7\u0095\n"+
		"\7\3\7\3\7\3\7\3\7\3\7\3\7\5\7\u009d\n\7\3\b\7\b\u00a0\n\b\f\b\16\b\u00a3"+
		"\13\b\3\t\3\t\3\t\3\t\3\t\3\t\5\t\u00ab\n\t\3\n\3\n\3\n\3\n\3\n\3\n\3"+
		"\n\3\n\3\13\7\13\u00b6\n\13\f\13\16\13\u00b9\13\13\3\f\3\f\3\f\3\f\3\f"+
		"\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f