...
//		BasedExcepted,
		...
		MessageExpected,
		UnknowError,
		FilterMethodMissing, NotExpectedDefine, NotExpectedOn, NotExpectedAdd, YouCanUseOnceTimeAssets, MissingError("Falta un error descriptivo o no corresponde un error grave"), ClassNotFound,
		;
