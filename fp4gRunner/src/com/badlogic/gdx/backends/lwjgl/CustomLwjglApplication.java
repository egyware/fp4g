 ...
 ******************************************************************************/
//ES UNA COPIA!! Sin embargo le añadí una linea.
...
public class CustomLwjglApplication implements Application {
	...
	public CustomLwjglApplication (ApplicationListener listener, String title, int width, int height, boolean useGL2) {
		this(listener, createConfig(title, width, height, useGL2));
	}

	public CustomLwjglApplication (ApplicationListener listener) {
		this(listener, null, 640, 480, false);
	}

	public CustomLwjglApplication (ApplicationListener listener, LwjglApplicationConfiguration config) {
		this(listener, config, new LwjglGraphics(config));
	}

	public CustomLwjglApplication (ApplicationListener listener, boolean useGL2, Canvas canvas) {
		this(listener, new LwjglApplicationConfiguration(), new LwjglGraphics(canvas, useGL2));
	}

	public CustomLwjglApplication (ApplicationListener listener, LwjglApplicationConfiguration config, Canvas canvas) {
		this(listener, config, new LwjglGraphics(canvas, config));
	}

	public CustomLwjglApplication (ApplicationListener listener, LwjglApplicationConfiguration config, LwjglGraphics graphics) {
	...
	private void initialize () {
		mainLoopThread = new Thread("LWJGL Application") {
			...
			public void run () {
				...
				try {
					CustomLwjglApplication.this.mainLoop();
				} catch (Throwable t) {
					Display.destroy();
